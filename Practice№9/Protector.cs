    ...
    public class Protector
    {
        ...
        public static bool CheckPassword(string userName, string password)
        {
            if (_users.ContainsKey(userName))
            {
                ...
                var hashedPassword = PBKDF2.Hash_Password_With_Salt_Iteration(System.Text.Encoding.UTF8.GetBytes(password), PotentialUser.Salt, 3000, "SHA256");
        ...
        public static void Register(string userName, string password, string[] roles = null)
        {
            ...
            var hashedPassword = PBKDF2.Hash_Password_With_Salt_Iteration(System.Text.Encoding.UTF8.GetBytes(password), salt, 3000, "SHA256");
